...
class ConversationalRAG:
    ...
    def __init__(self):
        ...
        self.embedding = # define the embedding model code.
        self.llm = # define the llm model code,.
        self.logs = []
        self.retrievers = {}
    ...
    def _setup_retrievers(self):
        ...
        datasets = [
            "tech_docs", "faq_data", "news_articles"
        ]
        ...
        for dataset in datasets:
            try:
                ...
                # get the collection from chromdb
    ...
    def _create_contextual_query(self, current_query: str, history: List[Dict]) -> str:
        ...
        last_exchange = history[-1] if hostory else None
    ...
    def process_query(self, query, dataset: str, conversation_history: List[Dict] = None)-> Tuple[str, List[str]]:
        ...
        try:
            ...
            # log conversational memory details
